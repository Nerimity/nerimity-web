...
import { createServerRolesStore } from "./createServerRolesStore";
...
export class ContextStore {
  ...
  serverRoles: ReturnType<typeof createServerRolesStore>;
  constructor() {
    ...
    this.serverRoles = createServerRolesStore(this);
    setReady(true);
  }
  dispose() {
    this.socket.dispose();
