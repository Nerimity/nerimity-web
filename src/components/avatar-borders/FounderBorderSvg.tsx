...
import styles from "./FounderBorderSvg.module.css";

export function FounderBorderSvg(props: {
  children?: JSXElement;
  color?: string;
  url?: string;
  hovered?: boolean;
    ...
    >
      ...
      >
        <defs>
          ...
          >
            <stop offset="0" stop-color="#00E692" />
            <stop offset=".781" stop-color="#00CC30" />
            <stop offset="1" stop-color="#33CC52" />
          </radialGradient>
          <radialGradient
            id="founder-badge-g2"
            cx="0"
          ...
          >
            <stop offset="0" stop-color="#1FFFA5" />
            <stop offset=".6" stop-color="#00DB80" />
            <stop offset="1" stop-color="#00CC81" />
          </radialGradient>
          <radialGradient
            id="founder-badge-g3"
            cx="0"
          ...
          >
            <stop offset="0" stop-color="#1FFFA5" />
            <stop offset=".6" stop-color="#00DB7C" />
          ...
          >
            <stop offset="0" stop-color="#1FFFA5" />
            <stop offset=".6" stop-color="#00DB83" />
          ...
          >
            <stop offset="0" stop-color="#99FFDD" />
            <stop offset=".6" stop-color="#22FFAA" />
          ...
          >
            <stop offset="0" stop-color="#1FFFA2" />
            <stop offset=".6" stop-color="#22FFB9" />
            <stop offset="1" stop-color="#0088E3" />
          </radialGradient>
          <radialGradient
            id="founder-badge-g7"
          ...
          <linearGradient
            id="founder-badge-g13"
            x2="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="matrix(278.838,0,0,104.414,108.788,19.734)"
          >
            <stop offset="0" stop-color="#60FFBA" />
            <stop offset=".224" stop-color="#7DFF71" />
            <stop offset=".494" stop-color="#B3FFC5" />
            <stop offset=".607" stop-color="#24FDB8" />
            <stop offset=".819" stop-color="#19FDCC" />
            <stop offset="1" stop-color="#11AB5E" />
          </linearGradient>
          <radialGradient
            id="founder-badge-g14"
            cx="0"
            cy="0"
            r="1"
            gradientUnits="userSpaceOnUse"
          ...
          >
            <stop offset="0" stop-color="#0EFF4E" />
            <stop offset=".412" stop-color="#36FF97" />
            <stop offset="1" stop-color="#0091ff" />
          </radialGradient>
          <clipPath clipPathUnits="userSpaceOnUse" id="founder-badge-cp1">
          ...
          >
            <stop offset=".214" stop-color="#00FFAE" />
            <stop offset=".469" stop-color="#11F0A6" />
            <stop offset=".767" stop-color="#2BFF5D" />
          </radialGradient>
          <linearGradient
            id="founder-badge-g16"
            x2="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="matrix(220.526,0,0,74.625,137.944,235.553)"
          >
            <stop offset="0" stop-color="#3AC27C" />
            <stop offset=".238" stop-color="#63EFFF" />
        ...
        />
        <g clip-path="url(#founder-badge-cp1)">
          <path
            id="founder-badge-&lt;Path&gt;"
            class={styles.s14}
