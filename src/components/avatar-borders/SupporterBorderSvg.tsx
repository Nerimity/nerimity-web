    ...
    >
      ...
      >
        <defs>
          ...
          <clipPath clipPathUnits="userSpaceOnUse" id="supporter-badge-cp1">
        ...
        />
        <g clip-path="url(#supporter-badge-cp1)">
