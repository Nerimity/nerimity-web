      ...
      <Content class="content">
        <CenterContainer>
          ...
          <Block title="Personal Information We Collect">
            ...
            may collect some information. The information we collect may include
            but not be limited to email address username, full name, age,
            messages, images or other content.
          </Block>
          ...
          <Block title="Data We Collect Automatically">
            While using Nerimity and its services, we will collect certain
            information such as your IP Address, your account creation date and
            your activities such as your online status. We may store this
            information in service providers' databases. We may also track and
            store details while you interact with Nerimity. This includes
            tracking the number of visitors to the website and the number of
            messages a user has sent. We collect IP addresses to limit or ban
            users attacking Nerimity.
          </Block>
          <Block title="Third-party services">
            ...
            save them in the database. We also use Googles Firebase Cloud
            Messaging to send push notifications to mobile decides.
          </Block>
          <Block title="Cookies">
            We use cookies and similar storage technologies to collect local
            data such as recent emojis, logged in users ID and other
            information. We may store and expand cookie usage to save more data
            as this service gets updated. We may use third-party technologies
            such as Cloudflare Turnstile that utilizes cookies to store some
            data and collect some data{" "}
            <CustomLink
              decoration
