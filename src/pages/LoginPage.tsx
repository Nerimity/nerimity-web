...
const Content = styled(FlexColumn)`
  background: turquoise; /* Changed to turquoise */
  height: 100%;
  border-radius: 8px;
  margin: 8px;
  margin-top: 0;
...
const TitleContainer = styled("div")`
  color: canaryyellow; /* Changed to canary yellow */
  font-size: 24px;
  font-weight: bold;
  margin-bottom: 30px;
`;
    ...
    <LoginPageContainer class="login-page-container">
      ...
      <Content>
        <Container class="container">
          ...
          >
            <TitleContainer>Canary Chat</TitleContainer> {/* Changed title to "Canary Chat" */}
            <Input
              margin={[10, 0, 10, 0]}
